...
namespace Unit06.Game.Directing
{
    public class SceneManager
    {
        ...
        private void Scene0(Cast cast, Script script)
        {
            AddRacket(cast);
            AddDialog(cast, Constants.ENTER_TO_START);

            script.ClearAllActions();
            AddInitActions(script); // initialize video and audio services
            // AddLoadActions(script);

            ChangeSceneAction a = new ChangeSceneAction(KeyboardService, "scene_1");
        ...
        private void Scene1(Cast cast, Script script)
        {
            // AddBricks(cast);
            AddRacket(cast);
            AddDialog(cast, "Press Space to continue");

            script.ClearAllActions();

            ChangeSceneAction a = new ChangeSceneAction(KeyboardService, "scene_2");
            script.AddAction(Constants.INPUT, a);
        ...
        private void Scene2(Cast cast, Script script)
        {

            AddRacket(cast);
            AddDialog(cast, "Scene 2, space to change");
