...
namespace Unit06.Game.Casting
{
    ...
    public class Racket : Actor
    {
        ...
        {
            _velocity = new Point(-Constants.RACKET_VELOCITY, _velocity.GetY());
        }
        ...
        public void Jump() 
        {
            _velocity = new Point(_velocity.GetX(), Constants.RACKET_JUMP);
        }

        public void StopJumping()
        {
            _velocity = new Point(_velocity.GetX(), 0);
        }
